...
def filter_quotes():
    ...
    # SQL query to select quotes based on author and rating
    query = "SELECT text FROM quotes WHERE 1=1"  # Исправлено название столбца
    params = []
    ...
    # Return the filtered quotes as a list
    return [quote[0] for quote in filtered]
